 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Albert Xing");
		  toPrint += p1.toString("axing6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Brian Lee");
		  toPrint += p2.toString("blee421");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Jay Jaganaath");
		  toPrint += p3.toString("jjaganaath3");
